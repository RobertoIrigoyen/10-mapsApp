...
export class MarkersPageComponent {
  ...
  public currentLngLat: LngLat = new LngLat(-3.6486749468614335, 40.388844489016606)
  ...
  ngAfterViewInit(): void {
    ...
    /*     const markerStyle = document.createElement('div');
    
        markerStyle.innerHTML = "Roberto Irigoyen"; */
  ...
  saveToLocalStorage() {
    const plaiMarkers: PlainMarker[] = this.markers.map(({ color, marker }) => {
      return {
        color,
